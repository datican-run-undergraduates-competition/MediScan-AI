      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center py-4">
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            <Link to="/voice-assistant" className="text-gray-700 hover:text-primary-500">Voice Assistant</Link>
            {user ? (
              <>
        ...
        {isMenuOpen && (
          <div className="md:hidden py-4">
            ...
            <Link to="/voice-assistant" className="block py-2 text-gray-700 hover:text-primary-500">Voice Assistant</Link>
            {user ? (
              <>
