...
from fastapi import FastAPI, Depends, HTTPException, statusfrom fastapi.responses import JSONResponsefrom .core.middleware import setup_middlewares# Create FastAPI appapp = FastAPI(    title="MediScan AI",    description="Early Disease Detection Through Multi-modal Medical Imaging Analysis",    version="0.1.0",)# Set up security middlewaresetup_middlewares(app)
