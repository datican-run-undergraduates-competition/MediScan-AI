...
async def upload_mri(
    ...
    user_dir = f"data/raw/mri/{current_user['username']}"
...
async def analyze_mri(
    ...
    conditions = [
        {"condition": "Stroke", "confidence": 0.75, "heatmap_path": None},
        {"condition": "Brain tumor", "confidence": 0.25, "heatmap_path": None},
        {"condition": "Multiple sclerosis", "confidence": 0.10, "heatmap_path": None},
    ]
