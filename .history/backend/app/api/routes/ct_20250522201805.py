...
async def upload_ct(
    ...
    user_dir = f"data/raw/ct/{current_user['username']}"
...
async def analyze_ct(
    ...
    conditions = [
        {"condition": "Lung cancer", "confidence": 0.65, "heatmap_path": None},
        {"condition": "Pulmonary embolism", "confidence": 0.30, "heatmap_path": None},
        {"condition": "Emphysema", "confidence": 0.20, "heatmap_path": None},
    ]
