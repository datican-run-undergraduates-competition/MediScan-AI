...
export default function CtUpload() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError('Failed to upload CT scan');
              ...
              >
                ...
                {files.length > 0 ? (
                  ...
                  <Typography>
                    {isDragActive
                      ? 'Drop the files here'
                      : 'Drag and drop CT scan files here, or click to select'}
                  </Typography>
                )}
              </Box>
            </Grid>
            ...
            <Grid item xs={12} sm={6}>
              <FormControl fullWidth required>
                ...
                >
                  ...
                  <MenuItem value="extremities">Extremities</MenuItem>
                </Select>
              </FormControl>
            </Grid>
